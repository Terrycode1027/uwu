...
> 從零開始，一步一步帶你安裝、設定、執行你的第一個 Flutter App！
...
Flutter 使用 **Dart** 語言，語法類似 Java / C#，如果你有 C 語言或其他程式經驗，上手會很快！
...
> ⚠️ **提醒：** 跑 Android 模擬器非常吃記憶體，如果你的電腦只有 8 GB RAM，建議使用實體手機測試。
...
點選 **"Download Flutter SDK"** 下載 `.zip` 壓縮檔。

**步驟 2：解壓縮到正確位置**

將 `.zip` 解壓縮到一個**沒有空白、沒有中文**的路徑，例如：
...
**步驟 1：使用 Homebrew 安裝（推薦）**

如果你還沒有安裝 Homebrew，先執行：
